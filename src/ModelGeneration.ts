...
function generateModels(
    ...
    databaseModel.forEach((element) => {
        ...
        switch (generationOptions.convertCaseFile) {
            case "camel":
                casedFileName = camelCase(element.fileName);
                break;
            case "param":
                casedFileName = paramCase(element.fileName);
                break;
            case "pascal":
                casedFileName = pascalCase(element.fileName);
                break;
            case "none":
...
function createIndexFile(
    ...
    const formatted:any = Prettier.format(rendered, prettierOptions);
    let fileName = "index";
    switch (generationOptions.convertCaseFile) {
        case "camel":
...
export function createHandlebarsHelpers(generationOptions: IGenerationOptions): void {
    ...
    Handlebars.registerHelper("toEntityName", (str) => {
        ...
        switch (generationOptions.convertCaseEntity) {
            case "camel":
                retStr = camelCase(str);
                break;
            case "pascal":
                retStr = pascalCase(str);
                break;
            case "none":
                retStr = str;
                break;
...
function createTsConfigFile(tsconfigPath: string): void {
    ...
    const formatted :any= Prettier.format(rendered, { parser: "json" });
